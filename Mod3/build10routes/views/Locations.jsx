...
function Locations(props){
    ...
    return(
        <div>
            <h1>Students Locations page</h1>
            <a href={`/students/home/locations/newyork`}><h2>Students From New York</h2></a>
            <a href={`/students/home/locations/dallas`}><h2>Students From Dallas</h2></a>
            <a href={`/students/home/locations/boston`}><h2>Students From Boston</h2></a>
            {/* <ul>
